...
export function CaptionInspector({
  ...
  return (
    <div className="flex h-full w-full bg-[#18181B] p-1.5 pr-0 text-white select-none shadow-2xl overflow-hidden rounded-2xl">
      <nav className="w-14 h-full bg-[#242428] flex flex-col items-center py-4 gap-4 shrink-0 rounded-[15px]">
        {/* Captions Tab */}
      ...
      <section className="flex-1 h-full flex flex-col overflow-hidden">
        {/* Top Header */}
        <header className="h-14 px-4 flex items-center justify-between shrink-0 gap-3">
          <h2 className="text-base font-bold text-white tracking-tight shrink-0">
            Captions
          </h2>
          ...
          {filteredItems.map((cue, index) => {
            ...
            return (
              <div
                ...
                className={`relative group px-6 py-3.5 flex items-center justify-between gap-4 transition-all duration-150 cursor-pointer ${
                  isActiveRow
              ...
              >
                ...
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  <span
                    className={`w-6 h-6 text-center text-xs font-mono font-semibold shrink-0 rounded-full flex items-center justify-center transition-all ${
                      isActiveRow
                        ...
                        return (
                          <span
                            ...
                            className={`transition-all select-none ${
                              isHigh
                                ? "bg-indigo-500/15 text-indigo-400 border border-indigo-500/30 rounded-md px-2 py-0.5 font-medium shadow-xs hover:bg-indigo-500/25 hover:scale-105"
                ...
                >
                  <MenuTrigger>
                    <Button
                      ...
                      className="w-7 h-7 p-0 text-[#71717A] hover:text-white rounded-md hover:bg-white/5 opacity-60 group-hover:opacity-100 transition-opacity"
                    >
